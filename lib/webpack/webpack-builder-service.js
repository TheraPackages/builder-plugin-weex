  ...
  */
  _dispatchBuild(proConfigs, buildType) {
    ...
    if (buildType === 'release' || build.apply === 'release') {
      ...
      buildConfig.devtool = build.types && build.types.release && build.types.release.devtool ? build.types.release.devtool : null;
      ...
      buildConfig.devtool = build.types && build.types.debug && build.types.debug.devtool ? build.types.debug.devtool : null;
    }
